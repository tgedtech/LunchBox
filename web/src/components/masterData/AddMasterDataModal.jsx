...
function AddMasterDataModal({
    ...
    const showToast = (message) => {
        const existing = document.getElementById('toast-duplicate');
        if (existing) existing.remove();

        const toast = document.createElement('div');
        toast.id = 'toast-duplicate';
    ...
    // Real-time validation for product name duplicates
            ...
            <div className="modal">
                <div className="modal-box rounded-2xl border border-base-300 bg-primary-content shadow-xl">
                    ...
                    <div className="mb-4">
                        ...
                        />
                        {nameError && (
                            <p className="validator-hint text-error text-xs mt-1">{nameError}</p>
                        )}
                    </div>
